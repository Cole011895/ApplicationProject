//
//  StudentPastAppointmentVC.swift
//  Testing
//
//  Created by Coleman Hedges on 2/24/17.
//  Copyright © 2017 Coleman Hedges. All rights reserved.
//

import UIKit

class TutorPastAppnVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableview.dequeueReusableCell(withIdentifier: "Past", for: indexPath) as! TutorPastAppointmentVTC
        
        var app = Dictionary<String,Any>()
        
        app = pastAppointments[indexPath.row]
        
        let name = app["StudentName"] as? String
    ...
    func loadPastAppts(){
        ...
        let url = URL(string: "http://cgi.soic.indiana.edu/~team55/pullPastApptsTutor.php")!
